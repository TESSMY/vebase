...
class SalesReportHelper
{
    ...
    public function recalculateMonthly()
    {
        ...
        $monthlySalesOrder = SalesReport::whereNull('client_id')->where('year', $this->date->year)->where('month', $this->date->month)->whereNotNull('day')->get();
        ...
        $monthlySalesOrder = SalesOrder::where('client_id', $this->salesOrder->client_id)->where('year', $this->date->year)->where('month', $this->date->month)->whereNotNull('day')->get();
        $cost = $monthlySalesOrder->sum('total_cost');
        $revenue = $monthlySalesOrder->sum('sub_total');
        $discount = $monthlySalesOrder->sum('discount_amount');

...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <span class="page-title h4">Request for Quotation</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white card shadow py-3 px-4">
            <div class="row mb-3">
                <a href="{{ route($routePrefix . '.' . $routeName . '.create') }}" class="col-12 col-md-2 mb-3 mb-md-0 btn btn-primary rounded"><i class="uil-plus-circle"></i> Create New Request for Quotation </a>
            </div>
            <form action="{{ route($routePrefix . '.' . $routeName . '.index') }}" method="GET" id="form">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-2 mb-3 mb-md-0 d-flex">
                        ...
                        <span class="my-auto">Request for Quotation</span>
                    </div>
            ...
            <div class="overflow-auto">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="100%" class="text-center">There are no Request for Quotation found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

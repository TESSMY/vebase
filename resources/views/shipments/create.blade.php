        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="page-title-box">
                    <span class="page-title h4">Create Shipment</span>
                </div>
            </div>
            <nav class="col-12 col-md-6">
                <ol class="breadcrumb d-md-flex justify-content-md-end my-auto">
                    <li class="breadcrumb-item"><a href="{{ route('admin.shipments.index') }}">Shipment</a></li>
        ...
        <div class="bg-white card shadow py-3 px-4">
            <form action="{{ route('admin.shipments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row col-12">
                    ...
                    <a href="/admin/shipments" class="col-12 col-md-1 btn btn-dark m-2">Back</a>
                </div>
            </form>
        </div>

...
class DeliveryOrderController extends Controller
{
    ...
    public function store()
    {
        ...
        $deliveryOrder = DeliveryOrder::create(request()->only(['sales_order_id', 'date', 'packed_by_date', 'payment_term', 'note']));
        $subTotal = 0;
    ...
    public function update(DeliveryOrder $deliveryOrder)
    {
        ...
        DB::beginTransaction();
        $deliveryOrder->update(request()->only(['sales_order_id', 'date', 'packed_by_date', 'payment_term', 'note']));
